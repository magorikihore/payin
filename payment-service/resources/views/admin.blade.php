        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <!-- Settings Dropdown -->
                    <div class="relative">
                        <button @click.stop="settingsOpen = !settingsOpen" class="text-sm text-amber-400 hover:text-amber-300 font-medium inline-flex items-center gap-1 transition">
                        ...
                        <div x-show="settingsOpen" @click.outside="settingsOpen = false" x-transition class="absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-2xl border z-[100] overflow-hidden">
                            <div class="px-4 py-3 bg-gray-50 border-b">
                                <p class="text-sm font-semibold text-gray-800" x-text="(user?.firstname || '') + ' ' + (user?.lastname || '')"></p>
                                <p class="text-xs text-gray-500" x-text="user?.email || ''"></p>
                            </div>
                            <div class="py-1">
                                <button @click.stop="showPwModal = true; settingsOpen = false" class="w-full flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition">
                                ...
                                <div class="w-full flex items-center justify-between px-4 py-2.5 text-sm text-gray-700">
                                    ...
                                    <div class="relative">
                                        <button @click.stop="toggleTwoFactor()" :disabled="twoFactorToggling"
