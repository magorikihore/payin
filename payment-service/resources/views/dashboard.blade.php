...
<div x-data="dashboard()" x-init="init()" x-cloak>
    ...
    <div class="lg:ml-64 pt-14 min-h-screen bg-gray-50">
        ...
        <div x-show="activeTab === 'invoices'" x-cloak>
            ...
            <div x-show="invoiceDetailOpen" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-3" @keydown.escape.window="invoiceDetailOpen = false">
                <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm max-h-[90vh] flex flex-col" @click.outside="invoiceDetailOpen = false">
                    <div class="px-5 py-3 border-b bg-gradient-to-r from-gblue-600 to-gblue-700 rounded-t-2xl text-center flex-shrink-0">
                        ...
                        <h3 class="text-base font-bold text-white">Invoice Details</h3>
                        <p class="text-[11px] text-blue-100">Share these details with your customer</p>
                    </div>
                        ...
                        <div class="flex flex-col min-h-0 flex-1">
                            ...
                            <div class="px-5 py-3 space-y-2">
                                ...
                                <div class="bg-amber-50 border border-amber-200 rounded-lg p-3 text-center">
                                    <div class="text-[11px] font-medium text-amber-600 mb-1">Customer pays with this reference</div>
                                    <div class="text-xl font-bold text-gray-900 tracking-widest flex items-center justify-center gap-2">
                            ...
                            <div class="px-5 py-3 border-t bg-gray-50 flex-shrink-0 rounded-b-2xl">
                                <!-- Share Invoice -->
                                <div x-show="invoiceDetail.status === 'waiting'" class="mb-2">
                                    <div class="text-[11px] font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Share Invoice</div>
                                    <!-- Share channel buttons -->
                                    <div class="flex items-center gap-1.5 mb-2">
                                        <button @click="shareInvoiceWhatsApp()" class="flex-1 flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg border border-gray-200 hover:border-green-400 hover:bg-green-50 transition group" title="WhatsApp">
                                        ...
                                        <button @click="shareInvoiceSms()" class="flex-1 flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg border border-gray-200 hover:border-blue-400 hover:bg-blue-50 transition group" title="SMS">
                                        ...
                                        <button @click="invoiceShareMode = invoiceShareMode === 'email' ? '' : 'email'" :class="invoiceShareMode === 'email' ? 'border-gblue-400 bg-gblue-50' : 'border-gray-200 hover:border-gblue-400 hover:bg-gblue-50'" class="flex-1 flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg border transition group" title="Email">
                                        ...
                                        <button @click="copyInvoiceLink()" class="flex-1 flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg border border-gray-200 hover:border-amber-400 hover:bg-amber-50 transition group" title="Copy Link">
