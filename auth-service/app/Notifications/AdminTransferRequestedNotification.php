...
class AdminTransferRequestedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $tpl = EmailTemplate::getByKey('admin_transfer_requested');
        ...
        return (new MailMessage)
            ->subject('Payin — New Transfer Request Requires Approval')
            ->greeting('Hello, ' . $data['admin_name'] . '!')
            ->line('A new internal transfer request has been submitted and requires your approval.')
            ...
            ->line('This transfer moves funds from Collection to Disbursement wallet.')
            ->line('Please log in to the admin panel to review and approve this transfer.')
            ->action('Review Transfers', config('app.admin_url', 'https://api.payin.co.tz/admin'))
